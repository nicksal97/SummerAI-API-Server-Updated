...
def index(request):
    ...
    if request.method == "POST":
        ...
        if tif_file is not None:
            ...
            # input_directory = 'runs/segment/predict/labels'
            # output_directory = 'static/centers'
            # create_center_point(input_directory, output_directory)
        ...
        # input_directory = 'runs/segment/predict/labels'
        # output_directory = 'static/centers'
        # output_image_path = cv2.imread(output_path)
        # create_center_point(input_directory, output_directory,output_image_path)
        # cv2.imwrite('static/output.png',output_image_path)
